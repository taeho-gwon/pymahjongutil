...
from pymahjong.yaku_checker.yakuman.chiihou import Chiihou
...
def test_chiihou(expected, is_tsumo_agari, player_wind, is_first_turn):
    agari_info = AgariInfo(
        is_tsumo_agari=is_tsumo_agari,
        player_wind=player_wind,
        is_first_turn=is_first_turn,
    )
    assert_yaku_check("123456789m11199p", expected, Chiihou(), agari_info)
